export type ViewKind = "list" | "kanban" | "dag" | "ship" | "memory" | "loops" | "new" | "doctor" | "inbox";
...
const VALID_VIEWS = new Set<ViewKind>(["list", "kanban", "dag", "ship", "memory", "loops", "new", "doctor", "inbox"]);
